...
async function fetchOfp(userid, { timeoutMs = 15000 } = {}) {
  const url = `https://www.simbrief.com/api/xml.fetcher.php?userid=${encodeURIComponent(userid)}&json=v2`;
...
module.exports = { fetchOfp, readCachedOfp, normalizeOfp };
